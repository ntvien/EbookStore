...
insert into publisher value ('London', 159753, 'London, England', 'londonpub@gmail.com', '45534636');
insert into publisher value ('Japan', 159754, 'KTX khu A, England', 'sfhdhdg@gmail.com', '4363656456');
insert into publisher value ('VietNam', 159755, 'KTX khu B, England', 'ldgsewpub@gmail.com', '6346456456');
insert into publisher value ('Paris', 159756, 'KTX khu C, England', 'londdgsdgpub@gmail.com', '4536356456');
insert into publisher value ('ThaiLand', 159757, 'KTX khu E, England', 'wetwnpub@gmail.com', '454366456456');
insert into publisher value ('Korea', 159758, 'KTX khu D, England', 'logb45g53ub@gmail.com', '42465656456');

insert into book value (999888777666555, null, 200000, 'Harry Potter and the Philosophers stone', 'London', 2000,2);
insert into book value (999888777666554, null, 300000, 'Harry Potter and the Chamber of Secrets', 'Japan', 1996,1);
insert into book value (999888777666553, null, 400000, 'Harry Potter and the Prisoner of Azkaban', 'VietNam', 1995,1);
insert into book value (999888777666552, null, 20000, 'ANH ẤY ĐÃ KHÔNG NẮM TAY TÔI', 'Paris', 2001,5);
insert into book value (999888777666551, null, 25000, 'DÁM ƯỚC MƠ SẼ KHÔNG CÒN SỢ HÃI', 'Korea', 2002,1);
insert into book value (999888777666550, null, 30000, 'CHI CHI CHÀNH CHÀNH - TUỔI THƠ ĐỂ DÀNH', 'London', 2003,8);
insert into book value (999888777666549, null, 35000, 'ÔN LUYỆN THI TỐT NGHIỆP THPT NĂM 2021 BÀI THI KHOA HỌC XÃ HỘI', 'VietNam', 2006,8);
insert into book value (999888777666548, null, 40000, 'TRẢ GIÁ', 'Korea', 2007,10);
insert into book value (999888777666547, null, 45000, 'HỌC NHẠC KHÔNG KHÓ - TỪ NHẠC LÝ - ĐẾN HÒA ÂM', 'Japan', 2008,11);
insert into book value (999888777666546, null, 50000, 'ĐƯỜNG XA GÁNH NẶNG', 'Paris', 2010,34);
insert into book value (999888777666545, null, 55000, 'HÁT VỀ BÀ RỊA - VŨNG TÀU 40 NĂM', 'VietNam', 2011,235);
insert into book value (999888777666544, null, 60000, 'HỌC VIỆN THÁM TỬ Q 16', 'Japan', 2012,25);
insert into book value (999888777666543, null, 65000, 'BẢO MẪU QUÁI VẬT', 'VietNam', 2013,26);
insert into book value (999888777666542, null, 70000, 'COMBO TIỂU THUYẾT KINH DỊ HAY NHẤT MỌI THỜI ĐẠI (BỘ 5 CUỐN)', 'ThaiLand', 2014,26);
insert into book value (999888777666541, null, 75000, 'NHỎ CON, CÓ CHỊU THÔI ĐI KHÔNG?', 'Korea', 1975,256);



insert into author value (123456789, 'J', 'K', 'Rowling', 'London, England', '123123123', 'F', 'jkrowling@gmail.com');
insert into author value (123456788, 'A', 'B', 'ABC', 'KTX khu A, England', '123123123', 'F', 'jkrYWYing@gmail.com');
insert into author value (123456787, 'C', 'D', 'CDE', 'KTX khu B, England', '123123123', 'F', 'jkWTWTling@gmail.com');
insert into author value (123456786, 'E', 'F', 'DEG', 'KTX khu C, England', '123123123', 'M', 'jkrowling@gmail.com');
insert into author value (123456785, 'G', 'H', 'EGH', 'KTX khu D, England', '123123123', 'M', 'jkEYERYling@gmail.com');
insert into author value (123456784, 'I', 'J', 'GHI', 'KTX khu E, England', '123123123', 'F', 'jRYEYRling@gmail.com');
insert into author value (123456783, 'K', 'L', 'HIJ', 'KTX khu F, England', '123123123', 'M', 'jkRYEling@gmail.com');
insert into author value (123456782, 'M', 'N', 'IJK', 'KTX khu G, England', '123123123', 'F', 'jkERYling@gmail.com');
insert into author value (123456781, 'O', 'P', 'JKM', 'KTX khu H, England', '123123123', 'F', 'jkYEYing@gmail.com');
insert into author value (123456780, 'Q', 'U', 'KMN', 'KTX khu I, England', '123123123', 'M', 'jkrYEEing@gmail.com');
insert into author value (123456779, 'W', 'X', 'OPQ', 'KTX khu J, England', '123123123', 'F', 'jkERYUTEing@gmail.com');
insert into author value (123456778, 'O', 'P', 'JKM', 'KTX khu H, England', '123123123', 'F', 'jkYEYing@gmail.com');
insert into author value (123456777, 'Q', 'U', 'KMN', 'KTX khu I, England', '123123123', 'M', 'jkrYEEing@gmail.com');
insert into author value (123456776, 'W', 'X', 'OPQ', 'KTX khu J, England', '123123123', 'F', 'jkERYUTEing@gmail.com');
insert into author value (123456775, 'Q', 'U', 'KMN', 'KTX khu I, England', '123123123', 'M', 'jkrYEEing@gmail.com');


insert into writtenby value (123456789,999888777666555);
insert into writtenby value (123456788,999888777666554);
insert into writtenby value (123456787,999888777666553);
insert into writtenby value (123456786,999888777666552);
insert into writtenby value (123456785,999888777666551);
insert into writtenby value (123456784,999888777666550);
insert into writtenby value (123456783,999888777666549);
insert into writtenby value (123456782,999888777666548);
insert into writtenby value (123456781,999888777666547);
insert into writtenby value (123456780,999888777666546);
insert into writtenby value (123456779,999888777666545);
insert into writtenby value (123456778,999888777666544);
insert into writtenby value (123456777,999888777666543);
insert into writtenby value (123456776,999888777666542);
